...
namespace Demo_FileAccess
{
    public class Transport
    {
        ...
        // --- Properties ---
        [JsonProperty] string Modell { get; } // Muss nicht public sein weil in Methode BeschreibMich aufgerufen, kann auch als Feld angegeben werden
        //Modell: ohne Methode müsste es public und Prop sein, dann kann direkt angesprochen werden
        [JsonProperty] uint maxGeschwindigkeit; // nur im Konstruktor also wird kein Setter benötigt, muss nicht public sein weil "BeschreibeMich" Wert ausgibt. Passt auch als Feld
        ...
        [JsonProperty] Zustand TranspZustand; //Muss nicht als Prop angelegt werden, weil gesetzt und gelesen wird es in den Methoden der Klassen
        ...
        {
            return Modell + maxGeschwindigkeit + TranspZustand;
